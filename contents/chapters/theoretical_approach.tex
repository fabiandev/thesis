...
\end{JsCode}
\end{program}
To enable type checks for the runtime, the enum has to be described with its members.%, which in the case of Prog.~\ref{prog:enum-compiled} is one member with the value of the number zero.
